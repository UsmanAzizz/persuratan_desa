...
<body>
    ...
    <div class="content">
        ...
        <p>Orang tersebut diatas benar - benar Warga Desa kami yang berdomisili di alamat tersebut dan berdasarkan catatan serta pengamatan kami, yang bersangkutan tergolong :</p>
        <p style="text-align: center; font-weight: bold;">( KELUARGA TIDAK MAMPU / PRA SEJAHTERA )</p>
        
        <p>Surat keterangan ini dipergunakan untuk keperluan: <strong><?= strtoupper($data_input['keperluan'] ?? '..................................') ?></strong>.</p>
