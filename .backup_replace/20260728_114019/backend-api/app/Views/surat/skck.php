...
<body>
    ...
    <div class="signature-container">
        ...
        <div class="signature-box">
            ...
            <p class="kades-name" style="text-decoration: underline; display:inline-block; margin-top: 100px; font-weight: bold;"><?= isset($warga['nama_lengkap']) ? strtoupper($warga['nama_lengkap']) : '...................' ?></p>
        </div>
        ...
        <div class="signature-box-right">
            ...
            <p class="kades-name" style="text-decoration: underline; margin-top: 100px; display:inline-block; font-weight: bold;">KUSNENDAR</p><br/>
        </div>
